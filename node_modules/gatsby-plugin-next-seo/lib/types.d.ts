 ...
 * @internal
 */
export declare type HtmlProps = JSX.IntrinsicElements['html'] & OtherElementAttributes;
/**
 * @internal
 */
export declare type BodyProps = JSX.IntrinsicElements['body'] & OtherElementAttributes;
/**
 * @internal
 */
export declare type LinkProps = JSX.IntrinsicElements['link'];
/**
 * @internal
 */
 ...
 * @internal
 */
export declare type NoscriptProps = JSX.IntrinsicElements['noscript'];
/**
 * @internal
 */
export declare type ScriptProps = JSX.IntrinsicElements['script'];
/**
 * @internal
 */
export declare type StyleProps = JSX.IntrinsicElements['style'];
/**
 * @internal
 */
export declare type TitleProps = JSX.IntrinsicElements['title'];
export {};
