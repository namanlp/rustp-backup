import { FocusEvent as ReactFocusEvent, MouseEvent as ReactMouseEvent, SyntheticEvent } from "react";
/**
 ...
 */
export declare function isOpeningInNewTab(event: MouseEvent | ReactMouseEvent): boolean;
/**
 * Checks whether the user event is triggering a download.
 */
export declare function isDownloading(event: MouseEvent | ReactMouseEvent): boolean;
/**
