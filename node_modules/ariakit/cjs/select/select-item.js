...
const useSelectItem = system.createHook(_ref => {
  ...
  state = store.useStore(state || __utils.SelectContext, [react.useCallback(s => isSelected(s.value, value), [value]), "setValue", "hide", "contentElement", "open"]);
  ...
  props = {
    role: dom.getPopupItemRole((_state5 = state) == null ? void 0 : _state5.contentElement),
  ...
  const focusOnHoverProp = hooks.useBooleanEvent(focusOnHover);
