...
const useHovercardDisclosure = system.createHook(_ref => {
  ...
  const onClickProp = props.onClick; // By default, hovercards don't receive focus when they are shown. When the
  ...
  const onFocusProp = props.onFocus; // Since the disclosure button is only visually hidden, it may receive focus
