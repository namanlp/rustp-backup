...
import { useControlledState, useTagName, useEvent, useWrapElement, useForkRef } from 'ariakit-utils/hooks';
...
const useCheckbox = createHook(_ref => {
  ...
  const onClick = useEvent(event => {
    ...
    if (event.defaultPrevented) return;
    if (nativeCheckbox) return; // @ts-expect-error The onChange event expects a ChangeEvent, but here we
