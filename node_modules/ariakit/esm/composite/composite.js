...
import { fireBlurEvent, fireFocusEvent, isSelfTarget, fireKeyboardEvent } from 'ariakit-utils/events';
import { hasFocus, focusIntoView } from 'ariakit-utils/focus';
import { useLiveRef, useSafeLayoutEffect, useEvent, useBooleanEvent, useForkRef } from 'ariakit-utils/hooks';
import { queueMicrotask } from 'ariakit-utils/misc';
import { useStoreProvider } from 'ariakit-utils/store';
import { createHook, createComponent, createElement } from 'ariakit-utils/system';
import { useFocusable } from '../focusable/focusable.js';
import { f as findEnabledItemById, s as silentlyFocused, i as isItem, C as CompositeContext, a as findFirstEnabledItem, g as groupItemsByRows } from '../__utils-7009759c.js';
...
const useComposite = createHook(_ref => {
  ...
  const activeItem = useMemo(() => findEnabledItemById(state.items, state.activeId), [state.items, state.activeId]);
