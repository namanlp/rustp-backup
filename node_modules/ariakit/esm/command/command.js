...
import { useTagName, useEvent, useForkRef } from 'ariakit-utils/hooks';
    ...
    if (isEnter || isSpace) {
      ...
      if (isEnter) {
        if (!nativeClick) {
          ...
          const click = () => fireClickEvent(element, eventInit); // If this element is a link with target="_blank", Firefox will
