...
const useMenuItem = createHook(_ref => {
  ...
  state = useStore(state || MenuContext, ["move", "hideAll", "contentElement"]) || menuBarState;
  ...
  const role = getPopupItemRole(state && "contentElement" in state ? state.contentElement : null, "menuitem");
  props = {
    role,
    ...props,
    onClick
