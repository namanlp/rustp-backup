...
const usePopoverDisclosureArrow = createHook(_ref => {
  var _placement, _state, _placement2;
  ...
  state = state || context;
  placement = (_placement = placement) != null ? _placement : (_state = state) == null ? void 0 : _state.placement;
  const dir = (_placement2 = placement) == null ? void 0 : _placement2.split("-")[0];
