...
function useTooltipState(_temp) {
  ...
  const [_open, __setOpen] = useState((_props$defaultOpen = props.defaultOpen) != null ? _props$defaultOpen : false);
  ...
  const [open, setOpen] = useControlledState((_props$defaultOpen2 = props.defaultOpen) != null ? _props$defaultOpen2 : false, (_props$open = props.open) != null ? _props$open : _open, nextOpen => {
    clearTimeouts();
