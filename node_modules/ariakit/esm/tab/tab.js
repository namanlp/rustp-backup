...
import { useId, useEvent } from 'ariakit-utils/hooks';
...
const useTab = createHook(_ref => {
  ...
  const panelId = getPanelId((_state2 = state) == null ? void 0 : _state2.panels, id);
  props = {
    id,
    role: "tab",
    "aria-selected": !!id && ((_state3 = state) == null ? void 0 : _state3.selectedId) === id,
