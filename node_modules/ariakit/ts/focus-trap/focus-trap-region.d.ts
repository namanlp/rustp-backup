 ...
 * ```
 */
export declare const useFocusTrapRegion: import("ariakit-utils/types").Hook<FocusTrapRegionOptions<"div">>;
/**
 ...
 * ```
 */
export declare const FocusTrapRegion: import("ariakit-utils/types").Component<FocusTrapRegionOptions<"div">>;
